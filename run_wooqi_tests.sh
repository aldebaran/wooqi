...
va=$(wooqi --seq_config testing/postfail_feature/tests/postfail_skip_all_test.ini --sn wooqi_tests)

echo -e $va | grep --quiet "ERROR at teardown"
if [ $? = 0 ];then
...
va=$(wooqi --seq_config testing/postfail_feature/tests/postfail_next_step.ini --sn wooqi_tests)
...
va=$(wooqi --seq_config testing/postfail_feature/tests/postfail_other_test.ini --sn wooqi_tests)
...
va=$(wooqi --seq_config testing/postfail_feature/tests/postfail_skip_all_test_same_test.ini --sn wooqi_tests)
...
va=$(wooqi --seq_config testing/postfail_feature/tests/postfail_next_step_same_test.ini --sn wooqi_tests)
...
va=$(wooqi --seq_config testing/postfail_feature/tests/postfail_other_test_same_test.ini --sn wooqi_tests)
...
va=$(wooqi --seq_config testing/postfail_feature/actions/postfail_skip_all_action.ini --sn wooqi_tests)
...
va=$(wooqi --seq_config testing/postfail_feature/actions/postfail_next_step.ini --sn wooqi_tests)
...
va=$(wooqi --seq_config testing/postfail_feature/actions/postfail_other_action.ini --sn wooqi_tests)
...
va=$(wooqi --seq_config testing/postfail_feature/actions/postfail_skip_all_action_same_action.ini --sn wooqi_tests)
...
va=$(wooqi --seq_config testing/postfail_feature/actions/postfail_next_step_same_action.ini --sn wooqi_tests)
...
va=$(wooqi --seq_config testing/postfail_feature/actions/postfail_other_action_same_action.ini --sn wooqi_tests)
...
va=$(wooqi --seq_config testing/reruns_feature/actions/reruns_different_actions.ini --sn wooqi_tests)
...
va=$(wooqi --seq_config testing/reruns_feature/actions/reruns_same_action.ini --sn wooqi_tests)
...
va=$(wooqi --seq_config testing/reruns_feature/tests/reruns_different_tests.ini --sn wooqi_tests)
...
va=$(wooqi --seq_config testing/reruns_feature/tests/reruns_same_test.ini --sn wooqi_tests)
...
va=$(wooqi --seq_config testing/uut_feature/actions/uut_different_actions.ini --sn wooqi_tests)
...
va=$(wooqi --seq_config testing/uut_feature/actions/uut_same_action.ini --sn wooqi_tests)

echo -e $va | grep --quiet "ERROR at teardown"
if [ $? = 0 ];then
    echo -e "- UUT feature | Same action --> ${RED}FAILED${NC}"
else
    echo -e "- UUT feature | Same action --> ${GREEN}${GREEN}PASSED${NC}"
fi

va=$(wooqi --seq_config testing/uut_feature/tests/uut_different_tests.ini --sn wooqi_tests)
...
va=$(wooqi --seq_config testing/uut_feature/tests/uut_same_test.ini --sn wooqi_tests)
...
va=$(wooqi --seq_config testing/uut2_feature/actions/uut2_different_actions.ini --sn wooqi_tests)
...
va=$(wooqi --seq_config testing/uut2_feature/actions/uut2_same_action.ini --sn wooqi_tests)
...
va=$(wooqi --seq_config testing/uut2_feature/tests/uut2_different_tests.ini --sn wooqi_tests)
...
va=$(wooqi --seq_config testing/uut2_feature/tests/uut2_same_test.ini --sn wooqi_tests)
...
va=$(wooqi --seq_config testing/loop_feature/tests/loop_same_test.ini --sn wooqi_tests)
...
va=$(wooqi --seq_config testing/loop_feature/tests/loop_different_tests.ini --sn wooqi_tests)
...
va=$(wooqi --seq_config testing/loop_feature/tests/loop_mixed_tests.ini --sn wooqi_tests)
...
va=$(wooqi --seq_config testing/loop_feature/actions/loop_same_action.ini --sn wooqi_tests)
...
va=$(wooqi --seq_config testing/loop_feature/actions/loop_different_actions.ini --sn wooqi_tests)
...
va=$(wooqi --seq_config testing/loop_feature/actions/loop_mixed_actions.ini --sn wooqi_tests)
...
va=$(wooqi --seq_config testing/loop_feature/tests/loop_different_tests_uut.ini --sn wooqi_tests)
