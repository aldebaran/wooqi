...
import py
# DON't import wooqi_pytest as pytest here because it causes import cycle troubles
import sys
import os
import wooqi.pytest._pytest._code
import wooqi.pytest._pytest.hookspec  # the extension point definitions
import wooqi.pytest._pytest.assertion
from wooqi.pytest._pytest._pluggy import PluginManager, HookimplMarker, HookspecMarker
from wooqi.pytest._pytest.compat import safe_str
...
def _prepareconfig(args=None, plugins=None):
    ...
    if args is None:
        ...
        from wooqi.pytest._pytest import deprecated
...
class PytestPluginManager(PluginManager):
    ...
    * ``conftest.py`` loading during start-up;
    ...
    def __init__(self):
        ...
        self.add_hookspecs(wooqi.pytest._pytest.hookspec)
        self.register(self)
        ...
        self.rewrite_hook = wooqi.pytest._pytest.assertion.DummyRewriteHook()
    ...
    def import_plugin(self, modname):
        ...
        if modname in builtin_plugins:
            importspec = "wooqi.pytest._pytest." + modname
        else:
            importspec = modname
...
class Parser:
    ...
    def parse(self, args, namespace=None):
        from wooqi.pytest._pytest._argcomplete import try_argcomplete
        self.optparser = self._getparser()
        try_argcomplete(self.optparser)
        return self.optparser.parse_args([str(x) for x in args], namespace=namespace)

    def _getparser(self):
        from wooqi.pytest._pytest._argcomplete import filescompleter
...
class Config(object):
    ...
    def _consider_importhook(self, args):
        ...
        if mode == 'rewrite':
            try:
                hook = wooqi.pytest._pytest.assertion.install_importhook(self)
            except SystemError:
                mode = 'plain'
            else:
...
def getcfg(args, warnfunc=None):
    ...
    """
    from wooqi.pytest._pytest.deprecated import SETUP_CFG_PYTEST
