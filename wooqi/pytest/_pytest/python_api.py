...
from wooqi.pytest._pytest.compat import isclass, izip
...
def approx(expected, rel=None, abs=None, nan_ok=False):
    ...
    from wooqi.pytest._pytest.compat import STRING_TYPES as String
...
def raises(expected_exception, *args, **kwargs):
    ...
    **Legacy forms**
    ...
    .. autoclass:: wooqi.pytest.pytest_code.ExceptionInfo
        :members:
    ...
    if not args:
        ...
        try:
            code = wooqi.pytest.pytest_code.Source(code).compile()
            py.builtin.exec_(code, frame.f_globals, loc)
            # XXX didn'T mean f_globals == f_locals something special?
            #     this is destroyed here ...
        except expected_exception:
            return wooqi.pytest.pytest_code.ExceptionInfo()
    else:
        func = args[0]
        try:
            func(*args[1:], **kwargs)
