...
from wooqi.pytest._pytest.capture import MultiCapture, SysCapture
from wooqi.pytest._pytest._code import Source
import py
import wooqi_pytest as pytest
from wooqi.pytest._pytest.main import Session, EXIT_OK
from wooqi.pytest._pytest.assertion.rewrite import AssertionRewritingHook
...
class Testdir:
    ...
    def parseconfig(self, *args):
        ...
        This invokes the pytest bootstrapping code in wooqi.pytest._pytest.config
        ...
        config = wooqi.pytest._pytest.config._prepareconfig(args, self.plugins)
