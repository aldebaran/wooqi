...
import itertools
from wooqi.pytest._pytest.main import EXIT_OK, EXIT_TESTSFAILED, EXIT_INTERRUPTED, \
...
class TerminalReporter:
    ...
    def __init__(self, config, file=None):
        ...
        if file is None:
            file = sys.stdout
        self._tw = self.writer = wooqi.pytest._pytest.config.create_terminal_writer(config,
                                                                                    file)
    ...
    def _report_keyboardinterrupt(self):
        ...
        if "KeyboardInterrupt" in msg:
            if self.config.option.fulltrace:
                ...
                self._tw.line(
                    "to show a full traceback on KeyboardInterrupt use --fulltrace", yellow=True)
