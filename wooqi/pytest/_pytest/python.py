...
import py
from wooqi.pytest._pytest.mark import MarkerError
from wooqi.pytest._pytest.config import hookimpl

import wooqi.pytest._pytest as _pytest
import wooqi.pytest._pytest._pluggy as pluggy
from wooqi.pytest._pytest import fixtures
from wooqi.pytest._pytest import main
...
class Module(main.File, PyCollector):
    ...
    def _importtestmodule(self):
        ...
        try:
            ...
            from wooqi.pytest._pytest._code.code import ExceptionInfo
...
class Metafunc(fixtures.FuncargnamesCompatAttr):
    ...
    def parametrize(self, argnames, argvalues, indirect=False, ids=None,
        ...
        """
        from wooqi.pytest._pytest.fixtures import scope2index
        from wooqi.pytest._pytest.mark import MARK_GEN, ParameterSet
...
def _find_parametrized_scope(argnames, arg2fixturedefs, indirect):
    ...
    """
    from wooqi.pytest._pytest.fixtures import scopes
...
def show_fixtures_per_test(config):
    from wooqi.pytest._pytest.main import wrap_session
    return wrap_session(config, _show_fixtures_per_test)


def _show_fixtures_per_test(config, session):
    import wooqi.pytest._pytest.config
    session.perform_collect()
    curdir = py.path.local()
    tw = wooqi.pytest.pytestconfig.create_terminal_writer(config)
