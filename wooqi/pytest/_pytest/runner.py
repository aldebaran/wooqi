...
import py
from wooqi.pytest._pytest.compat import _PY2
from wooqi.pytest._pytest._code.code import TerminalRepr, ExceptionInfo
from wooqi.pytest._pytest.outcomes import skip, Skipped, TEST_OUTCOME
...
def pytest_make_collect_report(collector):
    ...
    if not call.excinfo:
        ...
        from wooqi.pytest._pytest import nose
