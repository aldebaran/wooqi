...
* fix `#2208`_: ensure a iteration limit for wooqi.pytest.pytestcompat.get_real_func.
...
- streamlined and documented release process.  Also all versions
  ...
  from wooqi.pytest._pytest/__init__.py. Thanks Holger Krekel.
...
- reintroduced wooqi.pytest._pytest fixture of the pytester plugin which is used
